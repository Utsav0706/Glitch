...
MSc Software Engineering dissertation, University of Hertfordshire (module 7COM1039), supervised by Dr. Manjinder Kaur.
...
| Event | What it does |
|---|---|
| Gravity flip | Inverts world gravity |
| Wall disappearance | Removes level geometry agents were using for cover and pathing |
| Enemy duplication | Spawns copies of existing agents |
| Time stutter | Disrupts the flow of time the agents act within |
| Player duplication | Presents multiple player targets at once |
...
Utsav Jivani — [LinkedIn](https://www.linkedin.com/in/utsavjivani07) · [Portfolio](https://utsav0706.github.io) · utsavjivani.07@gmail.com
